...
class Effect extends VantaBase {
    ...
    async loadCryptoLogo() {
        const gltf = await loader.loadAsync( '3d/eth/pink/scene.gltf' )
        
        this.cryptoLogo2 = gltf.scene

        this.cryptoLogo2.scale.set(
            this.options.cryptoLogo2ScaleX,
            this.options.cryptoLogo2ScaleY,
            this.options.cryptoLogo2ScaleZ
        ) // Skaliert das Modell auf eine angemessene Größe

        this.cryptoLogo2.position.set(
            this.options.cryptoLogo2X,
            this.options.cryptoLogo2Y,
            this.options.cryptoLogo2Z
        ) // Positioniert das Modell in der Mitte


        // // Iteriere über alle Meshes im Modell und ändere deren Materialeigenschaften
        // this.cryptoLogo2.traverse(node => {
        //     if (node.isMesh) {
        ...
        this.cont2.add(this.cryptoLogo2) // Fügt das Modell der Szene hinzu
    }
    ...
    onUpdate() {
        ...
        if (this.cryptoLogo2) {
            this.cryptoLogo2.rotation.y += this.options.cryptoLogo2Speed // Dreht das Ethereum-Modell mit dem Globus
        }
