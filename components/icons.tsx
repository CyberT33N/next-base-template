...
export const PlaceHolder: React.FC<IconSvgProps> = ({
    size = 24,
    width,
    height,
    ...props
...
export const UsdIcon: React.FC<IconSvgProps> = ({
    size = 20,
    width,
    height,
    ...props
...
export const CopyClipboardIcon: React.FC<IconSvgProps> = ({
    size = 24,
    width,
    height,
    ...props
